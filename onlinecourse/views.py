...
# <HINT> Create a submit view to create an exam submission record for a course 
# enrollment. You may implement it based on following logic:
...
# <HINT> A example method to collect the selected choices from the exam form 
# the request object
...
# their question results and result for each question. You may implement it 
