...
# this method is used to collect the selected choices from the exam 
...
# create a new view for submitting an exam result (redirect to 
# show_exam_result with the submission id)
...
# create an exam result view to check if learner passed exam and show 
